...
UINT64 mtk_wcn_consys_timestamp_get(VOID)
{
	if (wmt_consys_ic_ops == NULL)
		wmt_consys_ic_ops = mtk_wcn_get_consys_ic_ops();

	if (wmt_consys_ic_ops && wmt_consys_ic_ops->consys_ic_timestamp_get)
		return wmt_consys_ic_ops->consys_ic_timestamp_get();
